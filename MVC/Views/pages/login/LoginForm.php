                ...
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form method="post" action="http://localhost/BTL_WEB/auth/login">
                    ...
                    <div class="form-outline mb-4">
                      ...
                      <input id="form2Example17" class="form-control form-control-lg" name="txtUser" value=""/>
                    </div>

                    <div class="form-outline mb-4">
                      <label class="form-label" for="form2Example27">Password</label>
                      <input type="password" id="form2Example27" class="form-control form-control-lg" name="txtPassword" value="" />
                    </div>
